...
public class VentanaControles extends JFrame {
	...
	private void initComponents() {
		...
		jbt1.addActionListener(e->jlbl1.setText("Ha pulsado")); // No es necesario meter la lambda en una variable para el listener se puede hacer asi
		
		ActionListener listener2=e->VentanaControles.this.getContentPane().setBackground(Color.yellow); //esto sería metiendolo en una variable
